...
namespace Neptun
{
			...
			where T : BaseDialogViewModel
		{
			...
			Application.Current.Dispatcher.Invoke(() =>
			{
				try
				{
					...
					{
						Dna.FrameworkDI.Logger.LogWarning(e.Message);
						throw;
					}
	...
	public class BaseMessageUserControl : UserControl
	{
		#region Private Members
		...
		/// The dialog window we will be contained within
		/// </summary>
		private MessageWindow mDialogWindow;
		...
		/// Default constructor
		/// </summary>
		public BaseMessageUserControl()
		{
			if (!DesignerProperties.GetIsInDesignMode(this))
			{
				// Create a new dialog window
				mDialogWindow = new MessageWindow();
				mDialogWindow.ViewModel = new MessageWindowViewModel(mDialogWindow);
